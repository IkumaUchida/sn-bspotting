...
def main():
    ...
    parser.add_argument(
        "--file_path",
        type=str,
        default="/workspace/data/soccernet_ball/bbox_txt/england_efl/2019-2020/2019-10-01 - Blackburn Rovers - Nottingham Forest/1_720p_yolov8/labels",
    ...
    max_bbox_size_array = get_max_bbox_size(args.file_path,totalframecount)
